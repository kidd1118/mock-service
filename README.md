click start_client.bat and start_server.bat to laounch service

mocking data in fakeData/* folder

from https://github.com/tjchaplin/signalRJS

POC form Kris Tseng

Implement form Leo Lee
